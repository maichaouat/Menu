...
{
    public class SubMenuInterface : MenuItemInterface
    {
        private List<MenuItemInterface> m_MenuItems;

        public List<MenuItemInterface> MenuItems
        {
            get
            {
                return m_MenuItems;
        ...
        public SubMenuInterface(string i_Title) : base(i_Title)
        {
            m_MenuItems = new List<MenuItemInterface>();
        }
        ...
        public void AddNewSubMenu(SubMenuInterface i_SubMenuNew)
        {
            m_MenuItems.Add(i_SubMenuNew);
            i_SubMenuNew.MenuItems.Insert(0, this);
        }
        public void AddNewAcetionFromMenu(ActionFromMenuInterface i_ActionFromMenuNew)
        {
